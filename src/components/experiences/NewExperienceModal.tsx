      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xl max-w-2xl w-full overflow-hidden animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900">新建经历资产卡片</h3>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto flex-1 custom-scrollbar">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-3">
            <div className="text-xs font-bold text-slate-800 flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-slate-400 font-normal">（标准化沉淀）</span>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-2.5 text-xs rounded-lg border border-slate-300 bg-white resize-none"
              />
            </div>
          ...
          <div className="pt-3 border-t border-slate-100 flex items-center justify-end gap-2">
            ...
            <button
              type="submit"
              className="px-5 py-2 text-xs bg-emerald-700 hover:bg-emerald-800 text-white font-bold rounded-lg shadow-xs transition"
            >
              保存至经历资产库
            </button>
          </div>
