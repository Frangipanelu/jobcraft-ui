        ...
        <div className="max-w-7xl mx-auto space-y-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1 flex items-center gap-2">
                ...
                <span>·</span>
                <span className="font-medium text-slate-700">{currentJob.salaryRange}</span>
                <span>·</span>
                <span className="text-slate-600">当前阶段：{currentJob.currentStage}</span>
              </p>
            </div>
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-200 text-xs font-semibold transition"
              >
          ...
          <div className="flex items-center gap-2 pt-2 border-t border-slate-100">
            ...
            >
              ...
              <span>JD 深度分析</span>
              {currentJD && (
                <span className="text-[10px] px-1.5 py-0.2 rounded-full bg-emerald-500/20 text-emerald-200">
